...
public class ParallelFixesFinderTest {
    ...
    private static final Map<String, Set<BugFix>> EXPECTED_PARALLEL_FIXES_1 = new HashMap<String, Set<BugFix>>();
    ...
    static {
        ...
        Set<BugFix> parallelNodes_2 = new HashSet<BugFix>(); // parallel nodes
                                                             // that fix test2
        parallelNodes_2.add(fix_1_2);
        parallelNodes_2.add(fix_2_2);

        Set<BugFix> parallelNodes_3 = new HashSet<BugFix>(); // parallel nodes
                                                             // that fix test3
        parallelNodes_3.add(fix_1_3);
        parallelNodes_3.add(fix_2_3);

        Set<BugFix> parallelNodes_4 = new HashSet<BugFix>(); // parallel nodes
                                                             // that fix test4
        parallelNodes_4.add(fix_1_4);
        parallelNodes_4.add(fix_2_4);
        parallelNodes_4.add(fix_3_4);

        Set<BugFix> parallelNodes_8 = new HashSet<BugFix>(); // parallel nodes
                                                             // that fix test8
    ...
    public void testFindParallelFixes1() {
        ...
        graph.addBugFixesInfo(NODE_4_1);
    ...
    public void testFindParallelFixes2() {
        ...
        graph.addBugFixesInfo(NODE_4_2);
    ...
    public void testFindParallelFixes3() {
        ...
        graph.addBugFixesInfo(NODE_7_3);
