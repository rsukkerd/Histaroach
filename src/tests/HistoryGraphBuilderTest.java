...
public class HistoryGraphBuilderTest {
    ...
    private static final Map<String, List<BugFix>> EXPECTED_BUG_FIXES_1 = new HashMap<String, List<BugFix>>();
    static {
    ...
    private static final Map<String, List<BugFix>> EXPECTED_BUG_FIXES_2 = new HashMap<String, List<BugFix>>();
    static {
    ...
    private static final Map<String, List<BugFix>> EXPECTED_BUG_FIXES_3 = new HashMap<String, List<BugFix>>();
    static {
        List<BugFix> fixList_1 = new ArrayList<BugFix>(); // of test1
    ...
    private static final Map<String, List<BugFix>> EXPECTED_BUG_FIXES_4 = new HashMap<String, List<BugFix>>();
    static {
        List<BugFix> fixList_1 = new ArrayList<BugFix>(); // of test1
